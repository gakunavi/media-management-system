...
| **U84** | **打ち手の型ごとの優先順位が決まっていない**（cowork 確認待ち） | 現在の並びは「表示回数の多い順」だけで、**タイトル改善／新規記事／内部リンク のどれを先にやるべきか**は考慮していない。実測では title_meta_rewrite 13件・new_article 8件・internal_link 1件が同列に並ぶ。SEO の判断が要るため cowork へ確認する |
