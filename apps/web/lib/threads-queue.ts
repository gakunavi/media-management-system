 ...
 * 投稿枠。1日13本 = 91本/週。
 *
 * ★本数の根拠: cowork の週次生成は 節税70本 + 代理店18本 = 88本/週。
 *   これを収めるには 12.6本/日 が要る。
 *
 * ★実績は 9.1本/日 だったが、これは「溢れた後」の数字。
 *   枠に入りきらなかった週18本前後が status=skip で落ち、
 *   一度も投稿されていない原稿が101本たまっていた。
 *   実績に合わせると、同じ取りこぼしを設計として固定してしまう。
 *
 * ★時刻は実績で本数の多かった13時間（posted 579件の分布）。
 *   16:53 / 20:44 / 07:43 / 08:41 / 18:41 / 10:40 / 11:40 /
 *   13:40 / 21:40 / 17:35 / 22:34 / 14:33 / 15:27
 */
const SLOT_HOURS = [7, 8, 10, 11, 13, 14, 15, 16, 17, 18, 20, 21, 22];
